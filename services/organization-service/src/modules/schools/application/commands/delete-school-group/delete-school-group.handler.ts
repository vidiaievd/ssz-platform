...
import { DeleteSchoolGroupCommand } from './delete-school-group.command.js';
import {
  SCHOOL_REPOSITORY,
...
@CommandHandler(DeleteSchoolGroupCommand)
export class DeleteSchoolGroupHandler implements ICommandHandler<DeleteSchoolGroupCommand> {
  constructor(
    @Inject(SCHOOL_REPOSITORY) private readonly schoolRepository: ISchoolRepository,
    @Inject(SCHOOL_GROUP_REPOSITORY) private readonly groupRepository: ISchoolGroupRepository,
  ) {}

  async execute(command: DeleteSchoolGroupCommand): Promise<void> {
