...
export const envSchema = z.object({
  ...
  REDIS_KEY_PREFIX: z.string().default('exercise-engine:'),
  ...
  CONTENT_SERVICE_BASE_URL: z.string().min(1, 'CONTENT_SERVICE_BASE_URL is required'),
  ...
  ORGANIZATION_SERVICE_BASE_URL: z.string().min(1, 'ORGANIZATION_SERVICE_BASE_URL is required'),
...
export default (): AppConfig => {
  ...
  return {
    ...
    content: {
      baseUrl: env.CONTENT_SERVICE_BASE_URL,
