...
import { GetTutorProfileByUserIdQuery } from './get-tutor-profile-by-user-id.query.js';

@QueryHandler(GetTutorProfileByUserIdQuery)
export class GetTutorProfileByUserIdHandler implements IQueryHandler<GetTutorProfileByUserIdQuery> {
  constructor(
  ...
  async execute(
    query: GetTutorProfileByUserIdQuery,
