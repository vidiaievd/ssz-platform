...
async function main(): Promise<void> {
  ...
  // 4. The atom graph, then the can-do links. Last, because both read what the modules
  // ended up holding rather than what the layout says they should hold.
  ...
  // teaches, or — for a practice-only module, which teaches no words of its own — the
  // ones of its Leksjon. Widening it to the whole course would credit an exercise for
  // every common noun that happens to appear in it.
