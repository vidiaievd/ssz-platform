...
import { PrismaLessonTextSpanRepository } from './infrastructure/persistence/prisma-lesson-text-span.repository.js';
...
import { PrismaGrammarRuleRepository } from '../grammar-rule/infrastructure/persistence/prisma-grammar-rule.repository.js';
...
import { UnmarkGlossaryWordHandler } from './application/commands/unmark-glossary-word/unmark-glossary-word.handler.js';
import { CreateTextSpanHandler } from './application/commands/create-text-span/create-text-span.handler.js';
import { UpdateTextSpanHandler } from './application/commands/update-text-span/update-text-span.handler.js';
import { DeleteTextSpanHandler } from './application/commands/delete-text-span/delete-text-span.handler.js';
...
import { GetTextSpansHandler } from './application/queries/get-text-spans/get-text-spans.handler.js';
...
const CommandHandlers = [
  ...
  UnmarkGlossaryWordHandler,
  CreateTextSpanHandler,
  UpdateTextSpanHandler,
  DeleteTextSpanHandler,
];
...
@Module({
  ...
  providers: [
    ...
    { provide: LESSON_TEXT_SPAN_REPOSITORY, useClass: PrismaLessonTextSpanRepository },
