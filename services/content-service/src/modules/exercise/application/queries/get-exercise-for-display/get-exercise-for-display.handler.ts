...
import { GetExerciseForDisplayQuery } from './get-exercise-for-display.query.js';
...
@QueryHandler(GetExerciseForDisplayQuery)
export class GetExerciseForDisplayHandler implements IQueryHandler<
...
> {
  ...
  async execute(
    query: GetExerciseForDisplayQuery,
